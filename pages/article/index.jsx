...
const article = {
  ...
  title: "用 node 写命令行工具",
  content: `
  <p>用来方便使用，免去繁琐的创建过程，所以写了个脚本工具，记录下来。</p><p>需求：执行 node 文件，在控制台输入 文章标题、文章分类、以及文件名后自动创建 MD 文件。实现的功能如下：</p><figure class="image"><img src="https://github.com/gershonv/note/blob/master/assets/node-shell.gif?raw=true" alt=""></figure><p>创建的内容如下：</p><p>---
title: node
